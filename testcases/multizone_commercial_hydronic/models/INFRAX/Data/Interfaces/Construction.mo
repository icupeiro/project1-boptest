...
partial record Construction "Template record for surface structure: define/order layers from outer to inner"
  ...
  replaceable parameter INFRAX.Data.Interfaces.Insulation insulationType(final d=
        insulationTickness) constrainedby INFRAX.Data.Interfaces.Insulation
    "Thermal insulation type, may be used to define 1 instance of mats[:]";
  parameter INFRAX.Data.Interfaces.Material[:] mats
