...
equation
  ...
  connect(ahuCon.dataBus, dataBus) annotation (Line(
      points={{60,-18.1739},{-100,-18.1739},{-100,0}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%second",
      index=1,
  ...
  connect(ahuCon.signalBus, signalBus) annotation (Line(
      points={{80.2,-18.1739},{100,-18.1739},{100,0}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%second",
      index=1,
 ...
 connect(dataBus.T3rdFlr_MTR,temLim. TSensor[2]) annotation (Line(
  ...
  connect(nightVent.NightVentilation, ahuCon.nightVentilation) annotation (Line(
        points={{-33,33.8},{14,33.8},{14,-24},{38,-24},{38,-27.3043},{60,
          -27.3043}},
        color={255,0,255}));
  connect(nightVent.NightVentilation, vavCon.nightVentilation) annotation (Line(
        points={{-33,33.8},{14,33.8},{14,-84},{60,-84},{60,-85.8333}}, color={
          255,0,255}));
  connect(signalBus, nightVent.signalBus) annotation (Line(
      points={{100,0},{14,0},{14,34},{-34,34}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
