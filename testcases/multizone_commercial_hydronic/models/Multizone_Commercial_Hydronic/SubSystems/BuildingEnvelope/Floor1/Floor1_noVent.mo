...
model Floor1_noVent
  ...
  IDEAS.Buildings.Components.RectangularZoneTemplate meetingRoom1(
    ...
    redeclare IDEAS.Buildings.Validation.Data.Constructions.HeavyFloor
      conTypFlo,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.ReinforcedGlassWall conTypA,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.PlasterWallCavity conTypB,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.ReinforcedGlassWall conTypC,
  ...
  IDEAS.Buildings.Components.RectangularZoneTemplate meetingRoom2(
    ...
    redeclare IDEAS.Buildings.Validation.Data.Constructions.HeavyFloor
      conTypFlo,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.ReinforcedGlassWall conTypA,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.GlassWall conTypB,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.ReinforcedGlassWall conTypC,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.PlasterWallCavity conTypD,
    bouTypFlo=IDEAS.Buildings.Components.Interfaces.BoundaryType.External,
    n50=1.3,
    redeclare package Medium = Medium,
    mSenFac=mSenFac,
  ...
  Multizone_Commercial_Hydronic.Data.Parameters.Str1stFlr str1stFlr "Record containing 1st floor data"
  ...
  IDEAS.Buildings.Components.InternalWall[2] internalWallNZ(
    ...
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.PlasterWall constructionType,
...
//       hWin=(str1stFlr.WindowF + str1stFlr.WindowG)/str1stFlr.WindowHeight1stFlr),
  IDEAS.Buildings.Components.Window SZ1Windows_east(
    ...
    redeclare Multizone_Commercial_Hydronic.SubSystems.BuildingEnvelope.Components.OverhangAndHorizontalFins
      ...
      wLeft=16.1,
      wRight=0.8 + 5,
      beta=0.5235987755983))     "Southern extension office eastern window" annotation (
...
//       beta=0.5235987755983),
  IDEAS.Buildings.Components.Window SZ1Windows_south(
    ...
    T_start=T_start) "Southern extension office southern window" annotation (
      Placement(transformation(
        extent={{6,-10},{-6,10}},
        rotation=-90,
        origin={-70,-96})));
...
//       beta=0.5235987755983),
  ...
  IDEAS.Buildings.Components.OuterWall[2] hallWalls(
    each inc=IDEAS.Types.Tilt.Wall,
    azi={Multizone_Commercial_Hydronic.Data.Orientations.N,Multizone_Commercial_Hydronic.Data.Orientations.inc},
...
//       dh=10 - 6.77),
  IDEAS.Buildings.Components.Window hallWindows_north(
    ...
    T_start=T_start) "Hall north window (next to bathroom)" annotation (
      Placement(transformation(
        extent={{6,10},{-6,-10}},
        rotation=180,
        origin={-92,42})));
...
//       dh=10 - 6.77),
  ...
  IDEAS.Buildings.Components.RectangularZoneTemplate bathroomZone(
    ...
    redeclare IDEAS.Buildings.Validation.Data.Constructions.HeavyFloor
      conTypFlo,
    bouTypB=IDEAS.Buildings.Components.Interfaces.BoundaryType.InternalWall,
    redeclare replaceable Multizone_Commercial_Hydronic.Data.Constructions.OuterWalls conTypA,
 ...
 IDEAS.Buildings.Components.Interfaces.ZoneBus[3] staW(each numIncAndAziInBus=
  ...
  IDEAS.Buildings.Components.InternalWall staW_WallC(
    ...
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.ConcreteWall constructionType,
    T_start=T_start)
  ...
  IDEAS.Buildings.Components.InternalWall staW_WallB(
    inc=IDEAS.Types.Tilt.Wall,
    azi=Multizone_Commercial_Hydronic.Data.Orientations.W,
  ...
  IDEAS.Buildings.Components.InternalWall staE_WallC(
    ...
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.SilicateWall constructionType,
    T_start=T_start)
  ...
  IDEAS.Buildings.Components.OuterWall[2] roof1stFlr(
    ...
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.Roof constructionType,
    each T_start=T_start)
  ...
  IDEAS.Buildings.Components.InternalWall[4] glassWall(
    each inc=IDEAS.Types.Tilt.Wall,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.GlassWall constructionType,
    azi={Multizone_Commercial_Hydronic.Data.Orientations.N,Multizone_Commercial_Hydronic.Data.Orientations.E,Multizone_Commercial_Hydronic.Data.Orientations.S,
        Multizone_Commercial_Hydronic.Data.Orientations.W},
  ...
  Multizone_Commercial_Hydronic.SubSystems.Controllers.DataBus dataBus
