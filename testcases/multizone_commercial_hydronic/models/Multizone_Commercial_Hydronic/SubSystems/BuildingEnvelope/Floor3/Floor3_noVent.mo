...
model Floor3_noVent
  ...
  IDEAS.Buildings.Components.RectangularZoneTemplate bathroomZone(
    ...
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.Roof conTypCei,
    n50=1.3,
  ...
  Multizone_Commercial_Hydronic.SubSystems.BuildingEnvelope.Floor3.Interfaces.RectangularZoneTABS copyRoom(
    bouTypA=IDEAS.Buildings.Components.Interfaces.BoundaryType.OuterWall,
    bouTypC=IDEAS.Buildings.Components.Interfaces.BoundaryType.InternalWall,
    aziA=Multizone_Commercial_Hydronic.Data.Orientations.N,
    ...
    bouTypD=IDEAS.Buildings.Components.Interfaces.BoundaryType.InternalWall,
    redeclare replaceable Multizone_Commercial_Hydronic.Data.Constructions.OuterWalls conTypA,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.ConcreteWall conTypD,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.PlasterWall conTypC,
    redeclare Multizone_Commercial_Hydronic.Data.Frames.Multizone_Commercial_HydronicWood fraTypA,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.Roof conTypCei,
    hasTABSCei=true,
    n50=1.3,
    redeclare Multizone_Commercial_Hydronic.Data.Glazing.SGGCLIMAPLUSONE4dash15dash6 glazingA,
    redeclare package Medium = Medium,
    mSenFac=mSenFac,
    T_start=T_start,
  ...
  "Big landscape office situated in the south sector of the floor"
    ...
    //energyDynamicsAir=energyDynamicsAir,
  Multizone_Commercial_Hydronic.SubSystems.BuildingEnvelope.Floor3.Interfaces.RectangularZoneTABS meetingRoom(
    bouTypA=IDEAS.Buildings.Components.Interfaces.BoundaryType.OuterWall,
    bouTypC=IDEAS.Buildings.Components.Interfaces.BoundaryType.InternalWall,
    bouTypD=IDEAS.Buildings.Components.Interfaces.BoundaryType.InternalWall,
    bouTypCei=IDEAS.Buildings.Components.Interfaces.BoundaryType.OuterWall,
    ...
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.GlassWall conTypC,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.PlasterWall conTypD,
    redeclare Multizone_Commercial_Hydronic.Data.Frames.Multizone_Commercial_HydronicWood fraTypA,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.Roof conTypCei,
    hasTABSCei=true,
    n50=1.3,
  ...
  "Big glazed meeting room situated in the mid-north face of the floor"
    ...
    //energyDynamicsAir=energyDynamicsAir,
    //outCei(energyDynamics=energyDynamicsTABS),
  Multizone_Commercial_Hydronic.SubSystems.BuildingEnvelope.Floor3.Interfaces.RectangularZoneTABS smallRoom(
    bouTypA=IDEAS.Buildings.Components.Interfaces.BoundaryType.OuterWall,
    bouTypC=IDEAS.Buildings.Components.Interfaces.BoundaryType.InternalWall,
 ...
 "Southern internal wall towards the east stair zone in the outer level"
  ...
  IDEAS.Buildings.Components.OuterWall inclinatedRoof(
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.StepRoof constructionType,
    azi=0,
