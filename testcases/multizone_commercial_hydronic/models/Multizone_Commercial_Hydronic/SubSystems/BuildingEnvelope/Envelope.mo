...
model Envelope "Envelope of Multizone_Commercial_Hydronic"
  ...
  outer IDEAS.BoundaryConditions.SimInfoManager sim(incAndAziInBus={{IDEAS.Types.Tilt.Floor,
        ...
        {IDEAS.Types.Tilt.Wall,Multizone_Commercial_Hydronic.Data.Orientations.N}})
  ...
  Multizone_Commercial_Hydronic.Data.Parameters.Str3rdFlr str3rdFlr
  "Record with 3rd floor data"
    annotation (Placement(transformation(extent={{120,-60},{140,-40}})));
  Multizone_Commercial_Hydronic.Data.Parameters.Str2ndFlr str2ndFlr
  "Record with 2nd floor data"
    annotation (Placement(transformation(extent={{120,-80},{140,-60}})));
  Multizone_Commercial_Hydronic.Data.Parameters.Str1stFlr str1stFlr
  "Record with 1st floor data"
    annotation (Placement(transformation(extent={{98,-80},{118,-60}})));
  Multizone_Commercial_Hydronic.Data.Parameters.StrGndFlr strGndFlr
 ...
 replaceable Multizone_Commercial_Hydronic.SubSystems.BuildingEnvelope.Floor1.Floor1 floor1(energyDynamicsAir=energyDynamicsAir, redeclare
  ...
  IDEAS.Buildings.Components.Zone basement(
    ...
    mSenFac=mSenFac,
    T_start=T_start)
  "Parking/garage of Multizone_Commercial_Hydronic"
    annotation (Placement(transformation(extent={{-40,-92},{-20,-72}})));
  IDEAS.Buildings.Components.SlabOnGround slabOnGround(redeclare
      Multizone_Commercial_Hydronic.Data.Constructions.Slab constructionType,
      A=structure.A_Grg,
      T_start=T_start)
  ...
  IDEAS.Buildings.Components.BoundaryWall boundaryWall(
    ...
    azi=0,
    use_T_in=true,
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.GarageWall constructionType,
  ...
  IDEAS.Buildings.Components.OuterWall[2] Grg_OuterWalls(
    redeclare Multizone_Commercial_Hydronic.Data.Constructions.GarageWallWithIns constructionType,
...
//array due to MPC compilation problems with JModelica
  ...
  "Extraction fan unit for the toilets"
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-92,-28})));
  IDEAS.Fluid.Sources.OutsideAir  outsideAir(        nPorts=1, redeclare
      package Medium =
        Medium)
...
//Extraction fan of the toilets
  connect(toiletExtract.port_b, outsideAir.ports[1]) annotation (Line(points={{-98,
          -28},{-98,-28},{-122,-28}}, color={0,127,255}));
  connect(floor3.bathExtract, toiletExtract.port_a) annotation (Line(points={{-12,
          66.6},{-50,66.6},{-50,-28},{-86,-28}},     color={0,127,255}));
  connect(floor2.bathExtract, toiletExtract.port_a) annotation (Line(points={{-12,
          24.8},{-50,24.8},{-50,-28},{-86,-28}},     color={0,127,255}));
  connect(floor1.bathExtract, toiletExtract.port_a) annotation (Line(points={{-12,
          -21.2},{-50,-21.2},{-50,-28},{-86,-28}},     color={0,127,255}));
