within Multizone_Commercial_Hydronic.SubSystems.BuildingEnvelope.Components;
model OverhangAndHorizontalFins "Roof overhang and horizontal fins"
  ...
  extends IDEAS.Buildings.Components.Shading.Interfaces.DoubleShading(
      redeclare IDEAS.Buildings.Components.Shading.HorizontalFins stateShading2(
        azi=azi,
      s=s,
      w=w,
      t=t,
      ...
      beta=beta),
      redeclare Multizone_Commercial_Hydronic.SubSystems.BuildingEnvelope.Components.Overhang stateShading1(
        azi=azi,
        hWin=hWin,
        wWin=wWin,
        wLeft=wLeft,
