...
model VentilationSystemSim
  extends VentilationSystem(
      ...
      allowFlowReversal=false,
            ...
            redeclare package Medium = MediumAir,
            from_dp=true),
redeclare IBPSA.Fluid.HeatExchangers.DryCoilEffectivenessNTU
                                              counterFlowHEX(
    ...
    redeclare Components.AHU_nonGEOTABS aHU(
      tauAir=60,
      tauSensor=60,
...
equation
  connect(supplyCAV.y, dp_ducts_supply.y)
    annotation (Line(points={{23,-11},{42,-11},{42,-34}},   color={0,0,127}));
  connect(extractCAV.y, dp_ducts_extract.y) annotation (Line(points={{-6.8,70},
