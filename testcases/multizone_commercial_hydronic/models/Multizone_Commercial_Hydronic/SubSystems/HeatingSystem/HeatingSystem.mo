...
model HeatingSystem "Heating system with no KPI"
...
//     replaceable package MediumGlycol = IDEAS.Media.Water;
  ...
  IBPSA.Fluid.HeatPumps.ScrollWaterToWater     heaPum1(
    ...
    TEvaMin=270.15,
    datHeaPum=Multizone_Commercial_Hydronic.Data.Parameters.DYNACIAT_200_LG_LGP(),
    dp1_nominal=48400,
    dp2_nominal=55500,
    tau1=200,
    tau2=200,
  ...
  IDEAS.Fluid.Sources.Boundary_pT sink(redeclare package Medium =
        IDEAS.Media.Water,
    nPorts=2,
    p=600000)                        annotation (Placement(transformation(
        extent={{6,-6},{-6,6}},
        rotation=-90,
        origin={32,2})));
  ...
  IBPSA.Fluid.HeatPumps.ScrollWaterToWater     heaPum2(
    ...
    scaling_factor=1,
    TEvaMin=270.15,
    datHeaPum=Data.Parameters.DYNACIAT_200_LG_LGP(),
    redeclare package Medium2 = MediumGlycol,
  ...
  IBPSA.Fluid.HeatExchangers.DryCoilEffectivenessNTU
    ...
    Q_flow_nominal=34000,
    T_a1_nominal=306.15,
    T_a2_nominal=301.15,
    UA=34000/Buildings.Fluid.HeatExchangers.BaseClasses.lmtd(
        33,
        33 - 34000/4180/e005.m2_flow_nominal,
        28,
        28 + 34000/4180/e005.m1_flow_nominal),
    redeclare package Medium1 = IDEAS.Media.Water,
    redeclare package Medium2 = MediumGlycol)      "Heat exchanger" annotation (
     Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=0,
        origin={172,48})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort tConOut(
    ...
    transferHeat=false,
    TAmb=291.15)
    annotation (Placement(transformation(extent={{28,110},{44,126}})));
...
//  connect(heaPum1.y, signalBus.HP_mod);
  ...
  connect(jun7.port_2, buffTank.ports[2]) annotation (Line(points={{47,40},{46,
          40},{46,48},{44,48},{4,48},{4,58}}, color={0,127,255}));
  ...
  connect(sink.ports[1], AHUCooCoi_b) annotation (Line(points={{33.2,8},{33.2,
          -32},{20,-32},{20,140}},
                              color={0,127,255}));
  ...
  connect(sink.ports[2], t19.port_a) annotation (Line(points={{30.8,8},{62,8},{
          62,-9},{78,-9}}, color={0,127,255}));
  connect(e005.port_a1, t29.port_b)
    annotation (Line(points={{162,42},{156,42}}, color={0,127,255}));
  connect(t30.port_a, e005.port_b1) annotation (Line(points={{187,26},{188,26},
          {188,42},{182,42}}, color={0,127,255}));
  connect(e005.port_a2, AHUHeaCoi_b) annotation (Line(points={{182,54},{182,98},
          {182,140},{180,140}}, color={0,127,255}));
  connect(e005.port_b2, AHUHeaCoi_a) annotation (Line(points={{162,54},{162,140},
          {160,140}}, color={0,127,255}));
  connect(jun6.port_1, tConOut.port_b) annotation (Line(points={{77,40},{76,40},
          {76,118},{44,118}}, color={0,127,255}));
  connect(tConOut.port_a, junHpConByp.port_2)
    annotation (Line(points={{28,118},{-44,118}}, color={0,127,255}));
  connect(tConOut.T, dataBus.TCon) annotation (Line(points={{36,126.8},{-50,
          126.8},{-50,136},{-200,136},{-200,18}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(boundary.ports[1], pump1.port_a) annotation (Line(points={{-188,-60},
          {-170,-60},{-170,-62},{-150,-62}}, color={0,127,255}));
  connect(t6.T, dataBus.T6) annotation (Line(points={{-129.7,-115},{-129.7,
          -48.5},{-199.9,-48.5},{-199.9,18.1}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(idealCircuitSwitch.port_c, massFlowRate.port_b)
    annotation (Line(points={{-150,0},{-150,-10}}, color={0,127,255}));
  connect(massFlowRate.port_a, pump1.port_b)
    annotation (Line(points={{-150,-30},{-150,-42}}, color={0,127,255}));
  connect(massFlowRate.m_flow, dataBus.mBorFlow) annotation (Line(points={{-161,
          -20},{-180,-20},{-180,18},{-200,18}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(sink1.ports[1], AHUHeaCoi_b) annotation (Line(points={{206,124},{182,
          124},{182,140},{180,140}}, color={0,127,255}));
