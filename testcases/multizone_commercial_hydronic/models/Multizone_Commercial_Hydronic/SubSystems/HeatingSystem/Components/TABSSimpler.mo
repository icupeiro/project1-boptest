...
model TABSSimpler "TABS System for the TACO approach"
  ...
  IDEAS.Fluid.HeatExchangers.RadiantSlab.EmbeddedPipe[15] cca0(
    ...
    redeclare each Multizone_Commercial_Hydronic.Data.Parameters.TABS RadSlaCha,
  ...
  IDEAS.Fluid.HeatExchangers.RadiantSlab.EmbeddedPipe[9] cca1(
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare Multizone_Commercial_Hydronic.Data.Parameters.TABS RadSlaCha,
    redeclare each package Medium = IDEAS.Media.Water,
    each massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    each nDiscr=3,
...
equation
  ...
  connect(cca0[1].port_b, tcca0.port_a)
    annotation (Line(points={{-4,-12},{38,-12},{38,-12}},color={0,127,255}));
  connect(cca0[2].port_b, tcca0.port_a);
  connect(cca0[3].port_b, tcca0.port_a);
  connect(cca0[4].port_b, tcca0.port_a);
  connect(cca0[5].port_b, tcca0.port_a);
  connect(cca0[6].port_b, tcca0.port_a);
  connect(cca0[7].port_b, tcca0.port_a);
  connect(cca0[8].port_b, tcca0.port_a);
  connect(cca0[9].port_b, tcca0.port_a);
  connect(cca0[10].port_b, tcca0.port_a);
  connect(cca0[11].port_b, tcca0.port_a);
  connect(cca0[12].port_b, tcca0.port_a);
  connect(cca0[13].port_b, tcca0.port_a);
  connect(cca0[14].port_b, tcca0.port_a);
  connect(cca0[15].port_b, tcca0.port_a);
  //CCA1
  ...
  connect(cca1[1].port_b, tcca1.port_a)
    annotation (Line(points={{-4,18},{38,18}},         color={0,127,255}));
  connect(cca1[2].port_b, tcca1.port_a);
  connect(cca1[3].port_b, tcca1.port_a);
  connect(cca1[4].port_b, tcca1.port_a);
  connect(cca1[5].port_b, tcca1.port_a);
  connect(cca1[6].port_b, tcca1.port_a);
  connect(cca1[7].port_b, tcca1.port_a);
  connect(cca1[8].port_b, tcca1.port_a);
  connect(cca1[9].port_b, tcca1.port_a);
  ...
  connect(cca2[1].port_b, tcca2.port_a)
    annotation (Line(points={{-4,46},{40,46},{40,46}},color={0,127,255}));
  connect(cca2[2].port_b, tcca2.port_a);
  connect(cca2[3].port_b, tcca2.port_a);
  connect(cca2[4].port_b, tcca2.port_a);
  connect(cca2[5].port_b, tcca2.port_a);
  connect(cca2[6].port_b, tcca2.port_a);
  connect(cca2[7].port_b, tcca2.port_a);
  ...
  connect(cca3[1].port_b, tcca3.port_a)
    annotation (Line(points={{-4,74},{40,74},{40,74}},color={0,127,255}));
