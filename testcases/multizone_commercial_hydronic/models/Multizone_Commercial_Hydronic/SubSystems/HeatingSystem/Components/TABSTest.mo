...
model TABSTest "TABS System for the TACO approach"
  Multizone_Commercial_Hydronic.Data.Parameters.Structure structure
  ...
  IDEAS.Fluid.HeatExchangers.RadiantSlab.EmbeddedPipe[15] cca0(
    redeclare each Multizone_Commercial_Hydronic.Data.Parameters.Multizone_Commercial_HydronicTABS RadSlaCha,
  ...
  IDEAS.Fluid.Movers.FlowControlled_dp     pump7(
    ...
    use_inputFilter=false,
    m_flow_nominal=hydronic.p07_m_flow,
    dp_nominal(displayUnit="kPa") = 14*9.81*1000,
  ...
  IDEAS.Fluid.HeatExchangers.RadiantSlab.EmbeddedPipe[9] cca1(
    redeclare Multizone_Commercial_Hydronic.Data.Parameters.Multizone_Commercial_HydronicTABS RadSlaCha,
    redeclare each package Medium = IDEAS.Media.Water,
    each massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    each nDiscr=3,
  ...
  IDEAS.Fluid.Sources.Boundary_pT cold(
    ...
    T=293.15,
    nPorts=2)
    annotation (Placement(transformation(extent={{164,-64},{144,-44}})));
  IDEAS.Fluid.Sources.Boundary_pT hot(
    redeclare package Medium = IDEAS.Media.Water,
    p=200000,
    T=297.15,
  ...
  Modelica.Blocks.Sources.Constant const(k=1)
    annotation (Placement(transformation(extent={{-114,-158},{-94,-138}})));
  Modelica.Blocks.Sources.IntegerConstant integerConstant(k=1)
    annotation (Placement(transformation(extent={{-160,-80},{-140,-60}})));
  Modelica.Blocks.Sources.Constant const1(k=0)
    annotation (Placement(transformation(extent={{-152,-124},{-132,-104}})));
...
equation
  ...
  connect(val_coo_sup.port_a, cold.ports[1]) annotation (Line(points={{-14,-60},
          {144,-60},{144,-52}}, color={0,127,255}));
  connect(cold.ports[2], val_coo_ret.port_b) annotation (Line(points={{144,-56},
          {124,-56},{124,-50},{98,-50},{98,-50}}, color={0,127,255}));
  connect(hot.ports[1], val_heat_sup.port_a) annotation (Line(points={{14,-168},
          {10,-168},{10,-162},{-60,-162},{-60,-126}}, color={0,127,255}));
  connect(hot.ports[2], val_heat_ret.port_b) annotation (Line(points={{10,-168},
          {18,-168},{18,-160},{70,-160},{70,-126}}, color={0,127,255}));
  connect(integerConstant.y, pump7.stage) annotation (Line(points={{-139,-70},{-104,
          -70},{-104,-43},{-69.6,-43}}, color={255,127,0}));
  connect(const.y, val_heat_sup.y) annotation (Line(points={{-93,-148},{-80,-148},
          {-80,-120},{-67.2,-120}}, color={0,0,127}));
  connect(const.y, val_heat_ret.y) annotation (Line(points={{-93,-148},{-16,-148},
          {-16,-120},{62.8,-120}}, color={0,0,127}));
  connect(const1.y, val_coo_sup.y) annotation (Line(points={{-131,-114},{-76.5,-114},
          {-76.5,-50.4},{-22,-50.4}}, color={0,0,127}));
  connect(const1.y, val_coo_ret.y) annotation (Line(points={{-131,-114},{90,-114},
          {90,-40.4}}, color={0,0,127}));
  connect(const2.y, val_cca0.y) annotation (Line(points={{-139,8},{-60,8},{-60,-2.4},
          {18,-2.4}}, color={0,0,127}));
  connect(const2.y, val_cca1.y) annotation (Line(points={{-139,8},{-58.5,8},{-58.5,
          27.6},{18,27.6}}, color={0,0,127}));
  connect(const2.y, val_cca2.y) annotation (Line(points={{-139,8},{-60,8},{-60,55.6},
          {18,55.6}}, color={0,0,127}));
  connect(const2.y, val_cca3.y) annotation (Line(points={{-139,8},{-60,8},{-60,83.6},
          {18,83.6}}, color={0,0,127}));
