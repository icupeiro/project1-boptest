...
equation
  connect(localWeather.y[2], weaDat.TDewPoi_in) annotation (Line(points={{-31,-10},{-26,-10},{-26,-38.8},{-101,-38.8}},
                                                color={0,0,127}));
  connect(localWeather.y[4], weaDat.winSpe_in) annotation (Line(points={{-31,-10},{-26,-10},{-26,-53.9},{-101,-53.9}},
                                                color={0,0,127}));
  connect(localWeather.y[5], weaDat.winDir_in) annotation (Line(points={{-31,-10},{-26,-10},{-26,-56},{-101,-56}},
                                              color={0,0,127}));
  connect(localWeather.y[6], weaDat.relHum_in) annotation (Line(points={{-31,-10},{-26,-10},{-26,-45},{-101,-45}},
                                              color={0,0,127}));
  connect(localWeather.y[7], weaDat.HDirNor_in) annotation (Line(points={{-31,-10},{-31,35.1},{-101,35.1},{-101,-61}},
                                              color={0,0,127}));
  connect(localWeather.y[8], weaDat.HDifHor_in) annotation (Line(points={{-31,-10},{-26,-10},{-26,-57.6},{-101,-57.6}},
                                                color={0,0,127}));
