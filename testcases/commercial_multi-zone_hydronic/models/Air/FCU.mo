...
package FCU
  ...
  package OptimalDesign "Optimal design models"
    ...
    model FCU
      ...
      Modelica.SIunits.Temperature TMax "Maximum temperature" annotation (Dialog(tab="General"));
      Modelica.SIunits.Temperature TMin "Minimum temperature" annotation (Dialog(tab="General"));
     ...
     Modelica.Fluid.Interfaces.FluidPort_a port_hea_a(
      ...
      IDEAS.Fluid.Sensors.TemperatureTwoPort senTem(
        ...
        tau=0) annotation (Placement(transformation(
            ...
            rotation=90,
            origin={-60,50})));
      Modelica.Blocks.Sources.RealExpression yCoo(y=min(1, max(0, (senTem.T - TMax)/dT)))
        annotation (Placement(transformation(extent={{-100,-40},{-80,-20}})));
      Modelica.Blocks.Sources.RealExpression yHea(y=min(1, max(0, (TMin - senTem.T)/dT)))
      ...
      IDEAS.Fluid.Actuators.Valves.TwoWayLinear valCoo(
        ...
        use_inputFilter=false,
        dpFixed_nominal=0,
        dpValve_nominal=dpValveCoo_nominal)
                                         "Two way valve for cooling"
      ...
      parameter Modelica.SIunits.PressureDifference dpValveHea_nominal
        "Nominal pressure drop of fully open valve for heating coil, used if CvData=IDEAS.Fluid.Types.CvTypes.OpPoint";
      parameter Modelica.SIunits.PressureDifference dpValveCoo_nominal
        "Nominal pressure drop of fully open valve for cooling coil, used if CvData=IDEAS.Fluid.Types.CvTypes.OpPoint";
      ...
      Modelica.Blocks.Interfaces.RealOutput P "Electrical power use" annotation (
          Placement(transformation(
            ...
            rotation=270,
            origin={-100,-110})));
      Modelica.Blocks.Sources.RealExpression yHea1(y=0.1)
    ...
    equation
      ...
      connect(add3_1.y, fan.m_flow_in) annotation (Line(points={{-45.5,29},{-40,29},{-40,12}}, color={0,0,127}));
      connect(add3_1.u1, yCoo.y) annotation (Line(points={{-57,33},{-74,33},{-74,-30},{-79,-30}}, color={0,0,127}));
      connect(yHea.y, add3_1.u2) annotation (Line(points={{-79,-50},{-70,-50},{-70,29},{-57,29}}, color={0,0,127}));
      ...
      connect(yHea.y, valHea.y) annotation (Line(points={{-79,-50},{60,-50},{60,-30},
              {68,-30}}, color={0,0,127}));
      ...
      connect(yCoo.y, yCooOut) annotation (Line(points={{-79,-30},{-60,-30},{-60,-110}},
            color={0,0,127}));
      connect(yHea.y, yHeaOut) annotation (Line(points={{-79,-50},{-79,-110},{-80,-110}},
            color={0,0,127}));
      connect(fan.P, P) annotation (Line(points={{-29,9},{-29,-86},{-100,-86},{-100,
              -110}}, color={0,0,127}));
      connect(yHea1.y, add3_1.u3) annotation (Line(points={{-79,26},{-70,26},{-70,24},{-57,24},{-57,25}}, color={0,0,127}));
...
First implementation.
          ...
          model PartialEffectivenessNTU
            ...
            import con = INFRAX.Air.FCU.IBPSA.Fluid.Types.HeatExchangerConfiguration;
            import flo = INFRAX.Air.FCU.IBPSA.Fluid.Types.HeatExchangerFlowRegime;
...
First implementation.
          ...
          function epsilon_ntuZ
            ...
            import f = INFRAX.Air.FCU.IBPSA.Fluid.Types.HeatExchangerFlowRegime;
